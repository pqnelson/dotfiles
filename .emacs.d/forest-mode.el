...
(defvar forest-tree-dir "~/src/forest/trees")
...
(defun forest-mode-create-tree ()
  ...
  (let ((choice (completing-read (format "Tree namespace [%s]: "
    ...
    ;;(insert (format-time-string "\\date{%F}\n"))
    (end-of-buffer)))
...
;; TODO: add a "new person" command
;; TODO: add a "new reference" command
;; TODO: add a "new theorem", "new definition", "new remark", "new proof" command?
